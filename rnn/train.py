...
parser.add_argument("--emsize", type=int, default=850, help="size of word embeddings")
parser.add_argument(
    "--nhid", type=int, default=850, help="number of hidden units per layer"
)
parser.add_argument(
    "--nhidlast",
    type=int,
...
parser.add_argument("--seed", type=int, default=1267, help="random seed")
...
parser.add_argument(
    "--save", type=str, default="EXP", help="path to save the final model"
)
parser.add_argument(
    "--alpha",
    type=float,
...
parser.add_argument(
    "--continue_train", action="store_true", help="continue train from a checkpoint"
)
parser.add_argument(
    "--small_batch_size",
    type=int,
...
parser.add_argument(
    "--single_gpu", default=True, action="store_false", help="use single GPU"
)
...
def train():
    ...
    while i < train_data.size(0) - 1 - 1:
        ...
        while start < args.batch_size:
            cur_data, cur_targets = data[:, start:end], targets[
                :, start:end
            ].contiguous().view(-1)
